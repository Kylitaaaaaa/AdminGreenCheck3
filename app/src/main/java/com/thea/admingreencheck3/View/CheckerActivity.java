...
public class CheckerActivity extends Fragment {
    ...
    public void onStart() {
        ...
        firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Checker, BuildingViewHolder>(Checker.class, R.layout.gen_row, BuildingViewHolder.class, mDatabase) {
            @Override
            protected void populateViewHolder(BuildingViewHolder viewHolder, Checker model, int position) {
                ...
                viewHolder.setTitle(model.getEmail());
