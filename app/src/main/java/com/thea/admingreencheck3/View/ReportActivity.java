...
import com.thea.admingreencheck3.ViewIndiv.ViewReportActivity;
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getChildrenCount() == 0) {
                    ...
                    emptyView.setText("No submitted reports yet");
                }
                else{
...
//                });
                ...
                rippleView.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
                    ...
                    public void onComplete(RippleView rippleView) {
                        Log.i("Sample", "pressed");
                        Intent i = new Intent(currView.getContext(), ViewReportActivity.class);
                        i.putExtra(Faculty.COL_ID, fac_position );
                        Log.i("idmodel", "model:  " + model.getId());
                        startActivity(i);
                    }
